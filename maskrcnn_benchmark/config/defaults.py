...
_C.MODEL.USE_CONFIDENCE = False
_C.MODEL.DISTILL_TEMPERATURE = 1

_C.MODEL.USE_COS_NORMALIZATION = False
...
_C.SOLVER.LAMBDA_FOR_PARAM = 1.0
_C.SOLVER.ALPHA_FOR_FISHER = 0.5
_C.SOLVER.DISTILL_TYPE = "abs"
